...
# Configuration
url = "k8s-harbor-harbor-e23646dd89-000fac67939de240.elb.us-east-1.amazonaws.com"
...
with open("tekton-setup/secret-docker-public.yaml", "w") as f:
    f.write(yaml_content)

print("Secret file created: tekton-setup/secret-docker-public.yaml")
